  ...
  module procedure caf_co_max
   ...
   select rank(a)
     rank(0)
       select type(a)
         type is(integer(c_int32_t))
           call c_co_max_int32(c_loc(a),  1_c_size_t, stat_ptr, optional_value(result_image))
         type is(integer(c_int64_t))
           call c_co_max_int64(c_loc(a),  1_c_size_t, stat_ptr, optional_value(result_image))
         type is(real(c_float))
           call c_co_max_float(c_loc(a),  1_c_size_t, stat_ptr, optional_value(result_image))
     ...
     rank(1)
       select type(a)
         type is(integer(c_int32_t))
           call c_co_max_int32(c_loc(a), size(a,kind=c_size_t), stat_ptr, optional_value(result_image))
         type is(integer(c_int64_t))
           call c_co_max_int64(c_loc(a), size(a,kind=c_size_t), stat_ptr, optional_value(result_image))
         type is(real(c_float))
