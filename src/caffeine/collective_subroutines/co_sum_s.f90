...
submodule(collective_subroutines_m) co_sum_s
  use iso_c_binding, only : c_int64_t, c_ptr, c_size_t, c_loc, c_float, c_double, c_null_ptr
...
contains
  ...
  module procedure caf_co_sum
   ...
   interface
     ...
     subroutine c_co_sum_int32(c_loc_a, Nelem, c_loc_stat, c_loc_result_image) bind(C)
     ...
     subroutine c_co_sum_float(c_loc_a, Nelem, c_loc_stat, c_loc_result_image) bind(C)
       import c_ptr, c_size_t
       type(c_ptr), value :: c_loc_a, c_loc_stat, c_loc_result_image
       integer(c_size_t), value :: Nelem
     end subroutine
