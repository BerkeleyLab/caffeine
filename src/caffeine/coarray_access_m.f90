...
module coarray_access_m
  ...
  implicit none
  private
  public :: prif_put, prif_put_strided, prif_put_raw, prif_put_raw_strided, prif_get, prif_get_raw, prif_get_raw_strided

  interface

     module subroutine prif_put( &
         coarray_handle, coindices, value, element_size, first_element_addr, team, team_number, stat, errmsg, errmsg_alloc)
       implicit none
     ...
     module subroutine prif_put_strided( &
         coarray_handle, coindices, value, element_size, first_element_addr, extent, stride, &
     ...
     module subroutine prif_put_raw(image_num, local_buffer, remote_ptr, size, stat, errmsg, errmsg_alloc)
       implicit none
     ...
     module subroutine prif_put_raw_strided( &
         ...
         local_buffer_stride, stat, errmsg, errmsg_alloc)
       implicit none
       integer(c_int), intent(in) :: image_num
       type(c_ptr), intent(in) :: local_buffer
       integer(c_intptr_t), intent(in) :: remote_ptr
     ...
     module subroutine prif_get(coarray_handle, coindices, mold, value, team, team_number, stat, errmsg, errmsg_alloc)
       implicit none
       type(prif_coarray_handle), intent(in) :: coarray_handle
       integer(c_intmax_t), intent(in) :: coindices(:)
